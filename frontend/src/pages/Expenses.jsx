...
export default function Expenses() {
  ...
  return (
    <div className="h-full min-h-0 overflow-auto custom-scrollbar pr-1 space-y-3 pb-3">
      <SectionCard
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 backdrop-blur-sm p-4">
          <div className="w-full max-w-3xl rounded-2xl border border-white/10 bg-slate-950/90 overflow-hidden">
            <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
              <h3 className="text-lg font-black text-white">Create Expense</h3>
