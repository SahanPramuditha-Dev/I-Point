    ...
    <div className="space-y-4">
      ...
      <div className="sticky bottom-0 z-20">
        <div className="rounded-2xl border border-indigo-400/30 bg-slate-950/95 backdrop-blur p-3 flex items-center justify-between gap-3">
          <div className="text-sm text-slate-300">Save roles, permissions, sessions, and security policy changes.</div>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-4xl rounded-2xl border border-white/10 bg-slate-950 p-5 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-black text-white">{editor.mode === "create" ? "Create Staff Account" : "Edit Staff Account"}</h3>
      ...
      {overrideModal.open && (
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-4xl rounded-2xl border border-white/10 bg-slate-950 p-5 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-black text-white">Permission Overrides - {overrideModal.user?.full_name || "-"}</h3>
